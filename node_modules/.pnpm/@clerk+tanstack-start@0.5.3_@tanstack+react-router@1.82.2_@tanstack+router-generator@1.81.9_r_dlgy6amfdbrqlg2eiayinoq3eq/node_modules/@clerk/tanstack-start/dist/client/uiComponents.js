import { UserProfile as UserProfile$1, OrganizationProfile as OrganizationProfile$1, OrganizationList as OrganizationList$1, CreateOrganization as CreateOrganization$1, SignIn as SignIn$1, SignUp as SignUp$1 } from '@clerk/clerk-react';
...
var CreateOrganization = (props) => {
  const path = usePathnameWithoutSplatRouteParams();
  return /* @__PURE__ */ jsx(CreateOrganization$1, { ...useRoutingProps("CreateOrganization", props, { path }) });
};
